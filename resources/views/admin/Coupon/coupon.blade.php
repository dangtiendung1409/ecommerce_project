...
@section("content")
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <hr/>
            <div class="col">
                <button type="button" onclick="saveData('0','','','')" class="btn btn-info px-5 radius-30" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Coupon</button>
            </div>
            <div class="card">
                <div class="card-body">
                            ...
                            @foreach($data as $list)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button onclick="deleteData('{{$list->id}}','coupons')" class="btn btn-danger px-5 radius-30">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
                        ...
                        <form id="formSubmit" action="{{url('admin/updateCoupon')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        <label for="enter_type" class="col-sm-3 col-form-label">Enter Your Type</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row mb-3">
                                        <label for="enter_value" class="col-sm-3 col-form-label">Enter Your Value</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="value" class="form-control" id="enter_value" placeholder="Enter Your Value" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="enter_minValue" class="col-sm-3 col-form-label">Enter Your MinValue</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="minValue" class="form-control" id="enter_minValue" placeholder="Enter Your MinValue" required>
                                        </div>
                                    </div>
