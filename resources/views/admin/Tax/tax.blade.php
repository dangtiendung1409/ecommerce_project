...
@section("content")
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <hr/>
            <div class="col">
                <button type="button" onclick="saveData('0','')" class="btn btn-info px-5 radius-30" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Tax</button>
            </div>
            <div class="card">
                <div class="card-body">
                            ...
                            @foreach($data as $list)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button onclick="deleteData('{{$list->id}}','taxes')" class="btn btn-danger px-5 radius-30">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
